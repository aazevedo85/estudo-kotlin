...
object Model {
    data class CharacterResponse(val code: Int,
                                 val status: String,
    ...
    data class DetailResponse(val code: Int,
                              val status: String,
                              val copyright: String,
                              val attributionText: String,
                              val attributionHTML: String,
    ...
    data class CharacterDetailData(val offset: Int,
                                   val limit: Int,
                                   val total: Int,
                                   val count: Int,
    ...
    data class CharacterData(val offset: Int,
                             val limit: Int,
                             val total: Int,
                             val count: Int,
    ...
    data class CollectionItem(val available: Int,
    ...
    data class ItemUrl(val type: String,
                       val url: String)
